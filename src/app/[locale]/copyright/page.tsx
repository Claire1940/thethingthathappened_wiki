...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - The Thing That Happened Wiki',
    description: 'Copyright and intellectual property information for The Thing That Happened Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - The Thing That Happened Wiki',
      description: 'Copyright and intellectual property information for The Thing That Happened Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2024-2026 The Thing That Happened Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of The Thing That Happened Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              The Thing That Happened Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>The Thing That Happened Developers</strong> - Creators of the The Thing That Happened game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>The Thing That Happened</strong> - Trademark of the game developers</li>
              <li><strong>The Thing That Happened Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with The Thing That Happened Wiki.
            </p>
            ...
            <p>
              ...
              The Thing That Happened Wiki<br />
              Email: <a href="mailto:dmca@thethingthathappened.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@thethingthathappened.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "The Thing That Happened Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: The Thing That Happened Wiki (thethingthathappened.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@thethingthathappened.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@thethingthathappened.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@thethingthathappened.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@thethingthathappened.wiki</a>
            </p>
            <p>
